...
class Sender:
    ...
    def ptp_send(self):
        ...
        fn = self._filename
        filecontent =  open(fn, "r").read()
        self.sender_socket.sendto("File content".encode("utf-8"), self.receiver_address)
        self.sender_socket.sendto(filecontent.encode("utf-8"), self.receiver_address)
        pass
